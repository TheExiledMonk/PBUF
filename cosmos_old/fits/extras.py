...
def _normalize_array_like(value: Any) -> Any:
    """Convert scalar or sequence inputs into numpy arrays when feasible."""
    if value is None:
        return None
...
def summarize_dataset(dataset: Any | None) -> Dict[str, Any]:
    """Extract lightweight metadata from datasets used in fits."""
    if dataset is None:
        return {}
...
def build_fit_extras(
    *,
    ...
    """
    Construct a richer extras dict for downstream consumers.
    """
    extras: Dict[str, Any] = {}
