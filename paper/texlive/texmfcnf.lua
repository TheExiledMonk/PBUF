...
return { 
  content = {
    variables = {
      TEXMFLOCAL = "selfautoparent:_texmf-local",
      TEXMFSYSVAR = "selfautoparent:_texmf-sysvar",
      TEXMFSYSCONFIG = "selfautoparent:_texmf-sysconfig",
      TEXMFHOME = "selfautoparent:_texmf-home",
      TEXMFVAR = "selfautoparent:_texmf-var",
      TEXMFCONFIG = "selfautoparent:_texmf-config",
    },
  },
}
