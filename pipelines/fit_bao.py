...
from dataio.loaders import load_bao_priors
from utils import logging as log
from utils.io import read_yaml, write_json_atomic, read_latest_result
...
def main():
    ...
    # ------------------------------------------------------------
    #  Load default and auto-calibrated parameters
    # ------------------------------------------------------------
    ...
    # 🔄 Try loading latest CMB calibration for this model
