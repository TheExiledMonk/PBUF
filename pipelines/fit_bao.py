...
def run_bao_fit(
    ...
    """
    Execute isotropic BAO fitting using unified engine with automatic optimized parameter usage.
    ...
    # Execute BAO fitting using unified engine with optimized parameters
