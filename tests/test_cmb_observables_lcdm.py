"""
Test: CMB distance-prior observables for LCDM.

We verify that the module cmb_observables(model) returns R, l_A, theta_star
that match their defining equations, using the LCDM background.
...
# --------------------------
# 1. Build a Planck-like LCDM model
# --------------------------
H0 = 67.4
h  = H0 / 100.0
Om0 = 0.315
...
print("\n✅ LCDM CMB observables test passed.")
